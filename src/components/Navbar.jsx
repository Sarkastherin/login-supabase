...
export function Navbar() {
  ...
  const { theme, handleToggleTheme } = useGlobal();
  ...
  return (
    <>
      <header
        className={`${theme === "dark" ? "dark:bg-slate-900" : "bg-slate-700"}`}
      >
          ...
          <div className="flex h-16 items-center justify-between">
            <div className="flex-1 md:flex md:items-center md:gap-2">
              <button
                type="button"
                onClick={toggleTheme}
                className="hidden rounded-full p-2 transition sm:block dark:bg-transparent-500 dark:text-white dark:hover:text-white/75"
              >
            ...
            <div className="md:flex md:items-center md:gap-12">
              ...
              <div className="relative hidden md:block">
                ...
                <div
                  className={`${!showMenu && 'hidden'} absolute end-0 z-10 mt-0.5 w-56 rounded-md border border-gray-100 bg-white shadow-lg dark:border-gray-800 dark:bg-gray-900`}
                  role="menu"
                >
                  <div className="p-2">
                    <a
